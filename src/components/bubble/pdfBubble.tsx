...
const PdfBubble: React.FC = () => {
    return (
        <div className="w-full p-4 bg-neutral-100 rounded-[10px] flex-col justify-start items-end gap-4 inline-flex">
            ...
            <div className="w-full flex-col justify-start items-end inline-flex gap-[-8px]">
                <PdfData number='발췌 1' pdfName='어쩌고.pdf' pdfPath=''/>
                <PdfData number='발췌 2' pdfName='어쩌고저쩌고.pdf' pdfPath=''/>
            </div>
        </div>
    );
};
