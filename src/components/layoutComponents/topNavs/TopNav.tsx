...
const TopNav: React.FC<TopNavProps> = ({
  ...
  const handleAdminToggle = () => {
    onToggleLearning(); // 토글 상태를 상위 컴포넌트로 전달
  };
  ...
  return (
    <div
      className="w-full h-[83px] fixed top-0 left-0 right-0 z-20
    ...
    >
      <div className="w-[336px] p-4 justify-start items-center gap-2.5 inline-flex">
        <button
          className="w-11 h-11 btnStyle-m justify-start items-center inline-flex
