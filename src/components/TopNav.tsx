...
const TopNav: React.FC = () => {
  ...
  return (
    <div
      className="w-full h-[83px] fixed top-0 left-0 z-10
    ...
    >
      ...
      <button
        className="justify-start items-center gap-1 inline-flex text-paragraph-m
                               text-neutral-400 fill-neutral-400
                               hover:text-blue-original hover:fill-blue-original
                               "
        onClick={openPaeperLiskLink}
      >
        <Icon name="infomation" width={18} height={18} />
